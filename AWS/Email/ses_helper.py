...
if __name__ == "__main__":
    sender_ = 'Marwan Nakhaleh <mnakhaleh@gmail.com>'
    recipients_ = ['mnakhaleh@gmail.com']
    title_ = 'Nigga you gay'
    text_ = 'Nigga you gay\nNigga you gay.'
    body_ = """<html><head></head><body><h1>Nigga you gay</h1><br>Nigga you gay."""
    attachments_ = []
